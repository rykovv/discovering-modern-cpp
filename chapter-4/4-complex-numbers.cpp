/*
    SDL1.2 used in the book example is no longer supported.
    Instead SDL2 is the current standard that implements
    a different user API.
    No time to figure out SDL. I'm here to learn C++. 
*/
